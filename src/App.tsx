...
const AdminSeoSettings = lazyWithRetry(() => import('./pages/AdminSeoSettings'));
// [CODELOFT CUSTOM] Кастомная страница CSS редактора и Панель CodeLoft
const AdminCustomCssSettings = lazyWithRetry(() => import('./pages/AdminCustomCssSettings'));
const CodeLoftPanel = lazyWithRetry(() => import('./pages/CodeLoftPanel'));
